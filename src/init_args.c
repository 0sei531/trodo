...
{
    data.intro.g_k[0] = 1;
    data.intro.g_k[1] = SDL_SCANCODE_W;
    data.intro.g_k[2] = SDL_SCANCODE_S;
    data.intro.g_k[3] = SDL_SCANCODE_A;
    data.intro.g_k[4] = SDL_SCANCODE_D;
    data.intro.g_k[5] = SDL_SCANCODE_RETURN;
    data.intro.g_k[6] = SDL_SCANCODE_LCTRL;
    data.intro.g_k[7] = SDL_BUTTON_LEFT;
    data.intro.g_k[8] = SDL_BUTTON_RIGHT;
    data.intro.g_k[9] = SDL_SCANCODE_SPACE;
    data.intro.g_k[10] = SDL_SCANCODE_LSHIFT;
    data.intro.g_k[11] = SDL_SCANCODE_TAB;
